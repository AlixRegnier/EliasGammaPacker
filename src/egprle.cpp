...
{
    std::size_t pos = 0;
    run_length_t run_length = 0;
    std::uint8_t state = (*input >> 7) & 1;
    bool stop = false;
    buffer.clear();
    ...
    TARGET(0, 0)
        ...
        GOTO_LOOP;
    TARGET(1, 0)
        buffer.push_back(MOD_PUSH(run_length));
        run_length = 8;
        state = std::uint8_t{0};
        GOTO_LOOP;
    TARGET(0, 1)
        buffer.push_back(MOD_PUSH(run_length + 7));
        run_length = 1;
        state = std::uint8_t{1};
        GOTO_LOOP;
    TARGET(1, 1)
        buffer.push_back(MOD_PUSH(run_length));
        buffer.push_back(MOD_PUSH(7));
        run_length = 1;
        state = std::uint8_t{1};
        GOTO_LOOP;
    TARGET(0, 2)
        buffer.push_back(MOD_PUSH(run_length + 6));
        buffer.push_back(MOD_PUSH(1));
        run_length = 1;
        state = std::uint8_t{0};
        GOTO_LOOP;
    TARGET(1, 2)
        buffer.push_back(MOD_PUSH(run_length));
        buffer.push_back(MOD_PUSH(6));
        buffer.push_back(MOD_PUSH(1));
        run_length = 1;
        state = std::uint8_t{0};
        GOTO_LOOP;
    ...
    TARGET(1, 3)
        ...
        GOTO_LOOP;
    TARGET(0, 4)
        buffer.push_back(MOD_PUSH(run_length + 5));
        buffer.push_back(MOD_PUSH(1));
        run_length = 2;
        state = std::uint8_t{0};
        GOTO_LOOP;
    ...
    TARGET(1, 7)
        ...
        GOTO_LOOP;
    TARGET(0, 8)
        buffer.push_back(MOD_PUSH(run_length + 4));
        buffer.push_back(MOD_PUSH(1));
        run_length = 3;
        state = std::uint8_t{0};
        GOTO_LOOP;
    ...
    TARGET(1, 15)
        ...
        GOTO_LOOP;
    TARGET(0, 16)
        buffer.push_back(MOD_PUSH(run_length + 3));
        buffer.push_back(MOD_PUSH(1));
        run_length = 4;
        state = std::uint8_t{0};
        GOTO_LOOP;
    ...
    TARGET(1, 31)
        ...
        GOTO_LOOP;
    TARGET(0, 32)
        buffer.push_back(MOD_PUSH(run_length + 2));
        buffer.push_back(MOD_PUSH(1));
        run_length = 5;
        state = std::uint8_t{0};
        GOTO_LOOP;
    ...
    TARGET(1, 63)
        ...
        GOTO_LOOP;
    TARGET(0, 64)
        buffer.push_back(MOD_PUSH(run_length + 1));
        buffer.push_back(MOD_PUSH(1));
        run_length = 6;
        state = std::uint8_t{0};
        GOTO_LOOP;
