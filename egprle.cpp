...
void EGPRLE::BitRunDFA(const std::uint8_t* const input, std::size_t length) {
    ...
    while(pos < length)
    {
        ...
        TARGET(0, 0)
            ...
            GOTO_LOOP;
        TARGET(1, 0)
            integers.push_back(run_length);
            run_length = 8;
            state = std::uint8_t{0};
            GOTO_LOOP;
        TARGET(0, 1)
            integers.push_back(run_length + 7);
            run_length = 1;
            state = std::uint8_t{1};
            GOTO_LOOP;
        TARGET(1, 1)
            ...
            GOTO_LOOP;
        TARGET(0, 2)
            integers.push_back(run_length + 6);
        ...
        TARGET(1, 3)
            ...
            GOTO_LOOP;
        TARGET(0, 4)
            integers.push_back(run_length + 5);
            integers.push_back(1);
            run_length = 2;
            state = std::uint8_t{0};
            GOTO_LOOP;
        ...
        TARGET(1, 7)
            ...
            GOTO_LOOP;
        TARGET(0, 8)
            integers.push_back(run_length + 4);
            integers.push_back(1);
            run_length = 3;
            state = std::uint8_t{0};
            GOTO_LOOP;
        ...
        TARGET(1, 15)
            ...
            GOTO_LOOP;
        TARGET(0, 16)
            integers.push_back(run_length + 3);
            integers.push_back(1);
            run_length = 4;
            state = std::uint8_t{0};
            GOTO_LOOP;
        ...
        TARGET(1, 31)
            ...
            GOTO_LOOP;
        TARGET(0, 32)
            integers.push_back(run_length + 2);
            integers.push_back(1);
            run_length = 5;
            state = std::uint8_t{0};
            GOTO_LOOP;
        ...
        TARGET(1, 63)
            ...
            GOTO_LOOP;
        TARGET(0, 64)
            integers.push_back(run_length + 1);
            integers.push_back(1);
            run_length = 6;
            state = std::uint8_t{0};
            GOTO_LOOP;
