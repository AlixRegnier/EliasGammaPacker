...
namespace EliasGammaPacker
{
   ...
   255, 0, 1, 1, 2, 2, 2, 2,
    ...
    constexpr std::uint64_t toBigEndian64(std::uint64_t val) {
    ...
    constexpr std::uint64_t toLittleEndian64(std::uint64_t val) {
